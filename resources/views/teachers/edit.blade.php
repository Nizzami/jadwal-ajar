...
<div class="container">
    ...
    <div class="card">
        ...
        <p class="description">
            Perbarui data guru dan batasan jam mengajarnya.
        </p>
        ...
        <form action="{{ route('teachers.update', $teacher) }}"
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    id="kode_guru"
                    name="kode_guru"
                    value="{{ old('kode_guru', $teacher->kode_guru) }}"
                    maxlength="30"
                    required
                >
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    value="{{ old('target_jp_per_minggu', $teacher->target_jp_per_minggu) }}"
                    min="1"
                    required
                >
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    value="{{ old('maksimal_jp_per_hari', $teacher->maksimal_jp_per_hari) }}"
                    min="1"
                    required
                >

                <span class="hint">
                    Batas maksimal jam mengajar dalam satu hari.
                </span>
            </div>
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    value="{{ old('maksimal_jp_berturut_turut', $teacher->maksimal_jp_berturut_turut) }}"
                    min="1"
                    required
                >
